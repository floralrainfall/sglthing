...
(define test-guy-model (quick-load-model "test/test_guy.dae"))
(define test-guy-animator (animator-create))
(define test-guy-animation (animation-create "test/test_guy_bust.dae" test-guy-model))
...
(define (script-frame-render world light-pass)
    ...
    (if (not light-pass) (animator-set-uniforms test-guy-animator rigged-shader))
